...
images_dir = 'C:/Users/ZhangXuemiao/temp/train'
...
if __name__=='__main__':
    # encode_to_tfrecords(images_dir,'train')
    filename_queue = tf.train.string_input_producer(['train'])
    # images, labels = get_batch(filename_queue,120)
    image, label = decode_from_tfrecord(filename_queue)
    # print(type(images))
    # print(type(labels))
    pass