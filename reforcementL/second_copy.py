...
class DQN(object):
    def __init__(self, env):
        ...
        self.summay_writer = tf.train.SummaryWriter('/tmp/to/logs', self.session.graph)
    ...
    def create_network(self):
        ...
        self.action_input = tf.placeholder(tf.float32, [None, self.action_dim], name='action-input')
        self.y_input = tf.placeholder(tf.float32, [None], name='y-input')
